...
export const characters: Character[] = [
  ...
  {
    file: "kagami", name: "若槻镜", role: "你——活在日常之人",
    quote: "只是想变得更强。强到能保护珍惜的东西。",
    monologue: "每次都是那样。\n只要我一哭由岐就会赶过来。\n因为我每次都只会哭……\n每次都什么也做不了……\n所以才想要变强。\n……我真是没用呢。\n要是我就那样一辈子都不结婚的话……\n你就稍微喜欢我一点吧……",
  },
  {
    file: "tsukasa", name: "若槻司", role: "我——无法成为任何人的我",
...
export const characterAssets: CharacterAsset[] = [
  ...
  { id: "kagami", name: "若槻镜", image: "/assets/chara-kagami.png", side: "right", accent: "活在日常之人", quote: "只是想变得更强。", order: 4 },
  { id: "tsukasa", name: "若槻司", image: "/assets/chara-tsukasa.png", side: "right", accent: "无法成为任何人的我", tags: ["sister"], order: 5 },
